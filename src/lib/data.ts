...
export const bairros = [
  { slug: "aberta-dos-morros", nome: "Aberta dos Morros" },
  { slug: "agronomia", nome: "Agronomia" },
  { slug: "anchieta", nome: "Anchieta" },
  { slug: "arquipelago", nome: "Arquipélago" },
  { slug: "auxiliadora", nome: "Auxiliadora" },
  { slug: "azenha", nome: "Azenha" },
  { slug: "bela-vista", nome: "Bela Vista" },
  { slug: "belem-novo", nome: "Belém Novo" },
  { slug: "belem-velho", nome: "Belém Velho" },
  { slug: "boa-vista", nome: "Boa Vista" },
  { slug: "bom-fim", nome: "Bom Fim" },
  { slug: "bom-jesus", nome: "Bom Jesus" },
  { slug: "camaqua", nome: "Camaquã" },
  { slug: "campo-novo", nome: "Campo Novo" },
  { slug: "cascata", nome: "Cascata" },
  { slug: "cavalhada", nome: "Cavalhada" },
  { slug: "centro-historico", nome: "Centro Histórico" },
  { slug: "chacara-das-pedras", nome: "Chácara das Pedras" },
  { slug: "chapeu-do-sol", nome: "Chapéu do Sol" },
  { slug: "cidade-baixa", nome: "Cidade Baixa" },
  { slug: "coronel-aparicio-borges", nome: "Coronel Aparício Borges" },
  { slug: "costa-e-silva", nome: "Costa e Silva" },
  { slug: "cristal", nome: "Cristal" },
  { slug: "cristo-redentor", nome: "Cristo Redentor" },
  { slug: "espirito-santo", nome: "Espírito Santo" },
  { slug: "extrema", nome: "Extrema" },
  { slug: "farrapos", nome: "Farrapos" },
  { slug: "farroupilha", nome: "Farroupilha" },
  { slug: "floresta", nome: "Floresta" },
  { slug: "gloria", nome: "Glória" },
  { slug: "guaruja", nome: "Guarujá" },
  { slug: "higienopolis", nome: "Higienópolis" },
  { slug: "hipica", nome: "Hípica" },
  { slug: "humaita", nome: "Humaitá" },
  { slug: "independencia", nome: "Independência" },
  { slug: "ipanema", nome: "Ipanema" },
  { slug: "jardim-botanico", nome: "Jardim Botânico" },
  { slug: "jardim-carvalho", nome: "Jardim Carvalho" },
  { slug: "jardim-do-salso", nome: "Jardim do Salso" },
  { slug: "jardim-europa", nome: "Jardim Europa" },
  { slug: "jardim-floresta", nome: "Jardim Floresta" },
  { slug: "jardim-isabel", nome: "Jardim Isabel" },
  { slug: "jardim-itu", nome: "Jardim Itu" },
  { slug: "jardim-leopoldina", nome: "Jardim Leopoldina" },
  { slug: "jardim-lindoia", nome: "Jardim Lindóia" },
  { slug: "jardim-sabara", nome: "Jardim Sabará" },
  { slug: "jardim-sao-pedro", nome: "Jardim São Pedro" },
  { slug: "lageado", nome: "Lageado" },
  { slug: "lami", nome: "Lami" },
  { slug: "lomba-do-pinheiro", nome: "Lomba do Pinheiro" },
  { slug: "mario-quintana", nome: "Mário Quintana" },
  { slug: "medianeira", nome: "Medianeira" },
  { slug: "menino-deus", nome: "Menino Deus" },
  { slug: "moinhos-de-vento", nome: "Moinhos de Vento" },
  { slug: "mont-serrat", nome: "Mont Serrat" },
  { slug: "morro-santana", nome: "Morro Santana" },
  { slug: "navegantes", nome: "Navegantes" },
  { slug: "nonoai", nome: "Nonoai" },
  { slug: "parque-santa-fe", nome: "Parque Santa Fé" },
  { slug: "partenon", nome: "Partenon" },
  { slug: "passo-da-areia", nome: "Passo da Areia" },
  { slug: "passo-das-pedras", nome: "Passo das Pedras" },
  { slug: "pedra-redonda", nome: "Pedra Redonda" },
  { slug: "petropolis", nome: "Petrópolis" },
  { slug: "ponta-grossa", nome: "Ponta Grossa" },
  { slug: "praia-de-belas", nome: "Praia de Belas" },
  { slug: "restinga", nome: "Restinga" },
  { slug: "rio-branco", nome: "Rio Branco" },
  { slug: "rubem-berta", nome: "Rubem Berta" },
  { slug: "santa-cecilia", nome: "Santa Cecília" },
  { slug: "santa-maria-goretti", nome: "Santa Maria Goretti" },
  { slug: "santa-rosa-de-lima", nome: "Santa Rosa de Lima" },
  { slug: "santa-tereza", nome: "Santa Tereza" },
  { slug: "santana", nome: "Santana" },
  { slug: "santo-antonio", nome: "Santo Antônio" },
  { slug: "sao-caetano", nome: "São Caetano" },
  { slug: "sao-geraldo", nome: "São Geraldo" },
  { slug: "sao-joao", nome: "São João" },
  { slug: "sao-sebastiao", nome: "São Sebastião" },
  { slug: "sarandi", nome: "Sarandi" },
  { slug: "serraria", nome: "Serraria" },
  { slug: "setimo-ceu", nome: "Sétimo Céu" },
  { slug: "teresopolis", nome: "Teresópolis" },
  { slug: "tres-figueiras", nome: "Três Figueiras" },
  { slug: "tristeza", nome: "Tristeza" },
  { slug: "vila-assuncao", nome: "Vila Assunção" },
  { slug: "vila-conceicao", nome: "Vila Conceição" },
  { slug: "vila-ipiranga", nome: "Vila Ipiranga" },
  { slug: "vila-jardim", nome: "Vila Jardim" },
  { slug: "vila-joao-pessoa", nome: "Vila João Pessoa" },
  { slug: "vila-nova", nome: "Vila Nova" },
...
export const generateBairroContent = (bairro: { slug: string; nome: string }) => {
